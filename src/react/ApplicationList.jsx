// ApplicationList.jsx Renders & passes props into ApplicationItems Renders
    ...
    return (
      ...
      col-sm-12 col-md-l2 col-lg-12">
        ...
        <div className="application-item col col-sm-6 col-md-6 col-lg-4">
          <div className="card card-block add-new-job-app">
        ...
        <NewApplicationForm onNewAppSubmit={this.props.onNewAppSubmit}/> {/* Render application list with newest jobs first */}
        {jobAppNodes.reverse()}
      </div>
    );
  }
